...
@Service
@Transactional
public class ClaireInventoryService {
    ...
    public ClaireInventoryService(ItemService itemService, WeaponService weaponService, RecoveryService recoveryService, KeyService keyService) {
    ...
    private void initializeInventory() {
        if (inventory.isEmpty()) {
            inventory.add(itemService.findById(31L).orElse(null));
